...
ZRAM_DAEMON_ENABLE=${ZRAM_DAEMON_ENABLE:-1}
ZRAM_DAEMON_PSI_WINDOW_US=${ZRAM_DAEMON_PSI_WINDOW_US:-10000000}
ZRAM_DAEMON_PSI_SOME_STALL_US=${ZRAM_DAEMON_PSI_SOME_STALL_US:-150000}
ZRAM_DAEMON_PSI_FULL_STALL_US=${ZRAM_DAEMON_PSI_FULL_STALL_US:-50000}
ZRAM_DAEMON_POLL_TIMEOUT_SEC=${ZRAM_DAEMON_POLL_TIMEOUT_SEC:-10}
ZRAM_DAEMON_PRESSURE_COOLDOWN_SEC=${ZRAM_DAEMON_PRESSURE_COOLDOWN_SEC:-120}
ZRAM_DAEMON_EMERGENCY_COOLDOWN_SEC=${ZRAM_DAEMON_EMERGENCY_COOLDOWN_SEC:-30}
ZRAM_DAEMON_RECOVERY_HYSTERESIS_SEC=${ZRAM_DAEMON_RECOVERY_HYSTERESIS_SEC:-180}
