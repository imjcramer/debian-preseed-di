...
desktop_validate_policy_env() {
  ...
  desktop_validate_uint_range LABWC_WAYBAR_TASKBAR_ICON_SIZE "${LABWC_WAYBAR_TASKBAR_ICON_SIZE:-20}" 8 128
  ...
  desktop_validate_uint_range LABWC_WOFI_WIDTH "${LABWC_WOFI_WIDTH:-720}" 320 4096
  desktop_validate_uint_range LABWC_WOFI_HEIGHT "${LABWC_WOFI_HEIGHT:-580}" 240 4096
  desktop_validate_uint_range LABWC_WOFI_IMAGE_SIZE "${LABWC_WOFI_IMAGE_SIZE:-22}" 8 128
  desktop_validate_uint_range LABWC_WOFI_FONT_SIZE "${LABWC_WOFI_FONT_SIZE:-15}" 8 32
...
desktop_write_default_config() {
  ...
  install -d -m 0755 "$(dirname "/target${defaults_path}")"
  {
    ...
    write_shell_config_var LABWC_FONT_WINDOW_SIZE "${LABWC_FONT_WINDOW_SIZE:-12}"
    write_shell_config_var LABWC_FONT_MENU_SIZE "${LABWC_FONT_MENU_SIZE:-13}"
    write_shell_config_var LABWC_FONT_OSD_SIZE "${LABWC_FONT_OSD_SIZE:-13}"
    write_shell_config_var LABWC_WAYBAR_HEIGHT "${LABWC_WAYBAR_HEIGHT:-46}"
    write_shell_config_var LABWC_WAYBAR_TASKBAR_ICON_SIZE "${LABWC_WAYBAR_TASKBAR_ICON_SIZE:-20}"
    write_shell_config_var LABWC_WAYBAR_TRAY_ICON_SIZE "${LABWC_WAYBAR_TRAY_ICON_SIZE:-18}"
    write_shell_config_var LABWC_WAYBAR_FONT_SIZE "${LABWC_WAYBAR_FONT_SIZE:-15}"
    write_shell_config_var LABWC_GTK_FONT_SIZE "${LABWC_GTK_FONT_SIZE:-12}"
    write_shell_config_var LABWC_WOFI_WIDTH "${LABWC_WOFI_WIDTH:-720}"
    write_shell_config_var LABWC_WOFI_HEIGHT "${LABWC_WOFI_HEIGHT:-580}"
    write_shell_config_var LABWC_WOFI_IMAGE_SIZE "${LABWC_WOFI_IMAGE_SIZE:-22}"
    write_shell_config_var LABWC_WOFI_FONT_SIZE "${LABWC_WOFI_FONT_SIZE:-15}"
    write_shell_config_var LABWC_CRYSTAL_DOCK_MINIMUM_ICON_SIZE "${LABWC_CRYSTAL_DOCK_MINIMUM_ICON_SIZE:-50}"
    write_shell_config_var LABWC_CRYSTAL_DOCK_MAXIMUM_ICON_SIZE "${LABWC_CRYSTAL_DOCK_MAXIMUM_ICON_SIZE:-80}"
    write_shell_config_var LABWC_CRYSTAL_DOCK_TOOLTIP_FONT_SIZE "${LABWC_CRYSTAL_DOCK_TOOLTIP_FONT_SIZE:-13}"
    write_shell_config_var LABWC_CRYSTAL_DOCK_APP_MENU_ICON_SIZE "${LABWC_CRYSTAL_DOCK_APP_MENU_ICON_SIZE:-40}"
    write_shell_config_var LABWC_CRYSTAL_DOCK_APP_MENU_FONT_SIZE "${LABWC_CRYSTAL_DOCK_APP_MENU_FONT_SIZE:-15}"
    write_shell_config_var LABWC_CRYSTAL_DOCK_CLOCK_FONT_SCALE_FACTOR "${LABWC_CRYSTAL_DOCK_CLOCK_FONT_SCALE_FACTOR:-1.0}"
